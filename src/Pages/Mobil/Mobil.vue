        ...
        <div class="w-full rounded-lg bg-gray-200">
            <nav class="flex flex-col sm:flex-row">
                <button v-on:click="TabClick(1)" v-bind:class=" Tab == 1 ? TabActive : TabNonActive">
                    ...
                    Tab 3
                </button><button v-on:click="TabClick(4)" v-bind:class="Tab == 4 ? TabActive : TabNonActive">
                    Tab 4
                </button>
            </nav>
        </div>
...
export default {
    ...
    beforeMount() {
        this.Tab = 1;
        this.TabActive = ' py-4 px-6 block hover:text-blue-500 focus:outline-none text-blue-500 border-b-2 font-medium border-blue-500'
        this.TabNonActive = 'text-gray-600 py-4 px-6 block hover:text-blue-500 focus:outline-none'
    },
    methods: {
